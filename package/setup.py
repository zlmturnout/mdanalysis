...
if __name__ == '__main__':
    ...
    extensions = [Extension('coordinates._dcdmodule', ['src/dcd/dcd.c'],
                  ...
                  Extension('coordinates.xdrfile._libxdrfile',
                            ...
                            include_dirs = include_dirs),
                  Extension('topology._psfgen',
                            sources=["src/psfgen/charmm_file.cpp",
                                     "src/psfgen/pdb_file.cpp",
                                     "src/psfgen/stringhash.cpp",
                                     "src/psfgen/charmm_parse_topo_defs.cpp",  
                                     "src/psfgen/pdb_file_extract.cpp",  
                                     "src/psfgen/extract_alias.cpp",           
                                     "src/psfgen/psf_file.cpp",          
                                     "src/psfgen/topo_defs.cpp",
                                     "src/psfgen/hasharray.cpp",               
                                     "src/psfgen/psf_file_extract.cpp",  
                                     "src/psfgen/topo_mol.cpp",
                                     "src/psfgen/hash.cpp",                    
                                     "src/psfgen/psfgen_data.cpp",       
                                     "src/psfgen/topo_mol_output.cpp",
                                     "src/psfgen/memarena.cpp",                
                                     "src/psfgen/psfgen_wrap.cpp"],
                            include_dirs = include_dirs,
                            libraries=["stdc++"],
                            language="c++")
                  ]
